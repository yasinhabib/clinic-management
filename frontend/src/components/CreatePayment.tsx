...
import { CREATE_PAYMENT, GET_PAYMENTS, GET_EXAMINATIONS } from '../graphql/queries';
...
export const CreatePayment = () => {
  ...
  if (!isAuthenticated) {
    return <p className="text-center text-red-500">Please login to create payments</p>;
  }

  return (
    <div className="container mx-auto px-4 max-w-2xl">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Create New Payment</h2>
